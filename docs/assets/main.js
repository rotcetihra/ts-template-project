                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var l = 0; l < c.length; l++) {
                                ...
                                this.metadata[i][a][d] == null ?
                                    (this.metadata[i][a][d] =
                                        e.metadata[i][a][d])
                                :   (this.metadata[i][a][d] = this.metadata[i][
                                        a
                                    ][d].concat(e.metadata[i][a][d]));
                            }
                        }
                    }
                }),
...
`),
    ...
    function Be(t, e, n) {
        ...
        if (t.children) {
            ...
            s.className =
                t.class ? `${t.class} tsd-accordion` : 'tsd-accordion';
    ...
    oe.endsWith('/') || (oe += '/');
    function $e() {
        document.querySelector('.tsd-full-hierarchy') ? ht() : (
