...
export default {
    ...
    // Требовать наличие специальной прагмы (например, `@format`) в начале файла,
    // чтобы Prettier применял форматирование. По умолчанию отключено.
    requirePragma: false,

    // Вставлять прагму автоформатирования в начало файла при записи.
    ...
    // true  — загонять `>` на ту же строку, что и последняя пропса
    ...
    // Каждую атрибут JSX на новой строке.
    ...
    // - "always":   жесткие переносы по printWidth
